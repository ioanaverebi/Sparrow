...
public class PrimitiveTypeHack implements IType {

	private String name;

	public PrimitiveTypeHack(String name) {
		this.name = name;
	}
	...
	@Override
	public void codeComplete(char[] snippet, int insertion, int position, char[][] localVariableTypeNames, char[][] localVariableNames, int[] localVariableModifiers, boolean isStatic, ICompletionRequestor requestor, WorkingCopyOwner owner)
